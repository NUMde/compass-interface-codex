...
#WORKDIR $APP_HOME
# COPY build.gradle.kts settings.gradle.kts gradle.properties compass-download-kotlin/build.gradle.kts gecco-easy/build.gradle.kts gecco-questionnaire/build.gradle.kts $APP_HOME
